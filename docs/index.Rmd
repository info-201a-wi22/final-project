...
# Summary Information:
Top 10 crime data categories: ```r crime_data_top_10``` = Alaska Airlines

Most committed crime groups in 2019: ```r most_committed_crime_group_2019```%

Least committed crime group in 2019: ```r least_committed_crime_group_2019 ```

Census tract with the highest household income by race in 2019: ```r highest_income_2019```

Census tract with the lowest household income by race in 2019: ```r lowest_income_2019```
...
```{Crime parent group top 10, echo = false}
### Show the top 10 table
